		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoice Demo",
									"targetURL": "#invoicefinaldemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicefinaldemo-display": {
								"semanticObject": "invoicefinaldemo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoice.finaldemo",
									"url": sap.ui.require.toUrl("invoice/finaldemo")
								}
							}
						}
					}
