		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#invoicedemoo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicedemoo-display": {
								"semanticObject": "invoicedemoo",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoice.demoo",
									"url": sap.ui.require.toUrl("invoice/demoo")
								}
							}
						}
					}
