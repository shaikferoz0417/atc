		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#invoiceautomationinvoiceautomation-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoiceautomationinvoiceautomation-display": {
								"semanticObject": "invoiceautomationinvoiceautomation",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoiceautomation.invoiceautomation",
									"url": sap.ui.require.toUrl("invoiceautomation/invoiceautomation")
								}
							}
						}
					}
